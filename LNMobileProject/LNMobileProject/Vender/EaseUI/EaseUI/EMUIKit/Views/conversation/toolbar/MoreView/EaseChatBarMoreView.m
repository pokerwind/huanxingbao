...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    UIFont *font14 = [UIFont systemFontOfSize:13];
    UIColor *color14 = [UIColor grayColor];
    
    _takePicButton =[UIButton buttonWithType:UIButtonTypeCustom];
    [_takePicButton setFrame:CGRectMake(insets * 1, 10, 50 , 70)];
    ...
    [_takePicButton.titleLabel setFont:font14];
    [_takePicButton setTitle:@"拍照" forState:UIControlStateNormal];
    [_takePicButton setTitleColor:color14 forState:UIControlStateNormal];
    [_takePicButton setTitleEdgeInsets:UIEdgeInsetsMake(50, -60, 0, 0)];
    [_takePicButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 20, 0)];
    //    _maxIndex = 2;
    [_scrollview addSubview:_takePicButton];
    
    _photoButton =[UIButton buttonWithType:UIButtonTypeCustom];
    [_photoButton setFrame:CGRectMake(insets * 2 + 50, 10, CHAT_BUTTON_SIZE , 70)];
    ...
    [_photoButton.titleLabel setFont:font14];
    [_photoButton setTitle:@"图片" forState:UIControlStateNormal];
    [_photoButton setTitleColor:color14 forState:UIControlStateNormal];
    [_photoButton setTitleEdgeInsets:UIEdgeInsetsMake(50, -60, 0, 0)];
    [_photoButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 20, 0)];
