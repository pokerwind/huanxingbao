...
/*
 产品信息拓展属性
 */
@property (assign, nonatomic) BOOL isFromProductDetail;
@property (strong, nonatomic) NSString *commodityImage;
@property (strong, nonatomic) NSString *commodityName;
@property (strong, nonatomic) NSString *commodityPrice;
@property (strong, nonatomic) NSString *commodityID;
@property (strong, nonatomic) NSString *commodityLink;
