...
- (IBAction)countbuttonClick:(JKCountDownButton *)sender {
    ...
    GetVerifyAPI *getApi = [[GetVerifyAPI alloc] initWithPhone:self.phoneTextField.text type:1];
...
//            [SVProgressHUD showSuccessWithStatus:model.info];
            DZSetPassVC *vc = [DZSetPassVC new];
