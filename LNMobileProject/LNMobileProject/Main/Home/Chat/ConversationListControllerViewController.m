...
- (void)login_out {
    ...
    [[[LGAlertView alloc] initWithTitle:@"" message:@"确定要退出登录?" style:LGAlertViewStyleAlert buttonTitles:@[@"确定"] cancelButtonTitle:@"取消" destructiveButtonTitle:@"" actionHandler:^(LGAlertView * _Nonnull alertView, NSUInteger index, NSString * _Nullable title) {
